(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("lodash"), require("styled-components"), require("moment"), require("prop-types"), require("js-md5"), require("react-autosuggest"), require("react-google-autocomplete"), require("react-markdown"));
	else if(typeof define === 'function' && define.amd)
		define("coderbox-components", ["react", "lodash", "styled-components", "moment", "prop-types", "js-md5", "react-autosuggest", "react-google-autocomplete", "react-markdown"], factory);
	else if(typeof exports === 'object')
		exports["coderbox-components"] = factory(require("react"), require("lodash"), require("styled-components"), require("moment"), require("prop-types"), require("js-md5"), require("react-autosuggest"), require("react-google-autocomplete"), require("react-markdown"));
	else
		root["coderbox-components"] = factory(root["react"], root["lodash"], root["styled-components"], root["moment"], root["prop-types"], root["js-md5"], root["react-autosuggest"], root["react-google-autocomplete"], root["react-markdown"]);
...
var EditableListItem = function (_React$Component) {
  ...
  function EditableListItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditableListItem.__proto__ || Object.getPrototypeOf(EditableListItem)).call.apply(_ref, [this].concat(args))), _this), _this.state = { editMode: false, isSaving: false }, _this.handleFormSave = function (form) {
  ...
  _createClass(EditableListItem, [{
    ...
    value: function render() {
      ...
      var FormElement = (0, _react.createElement)(_ListItemForm2.default, _extends({}, formProps, {
        item: item,
...
var ListItemForm = function ListItemForm(_ref) {
  ...
  var settingsKeys = (0, _lodash.sortBy)((0, _lodash.keys)(mergedSettings), function (key) {
    return mergedSettings[key].sort;
  });
  var children = [];
