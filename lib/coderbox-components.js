(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("styled-components"), require("lodash"), require("moment"), require("proptypes"), require("js-md5"), require("react-autosuggest"), require("react-markdown"));
	else if(typeof define === 'function' && define.amd)
		define("coderbox-components", ["react", "styled-components", "lodash", "moment", "proptypes", "js-md5", "react-autosuggest", "react-markdown"], factory);
	else if(typeof exports === 'object')
		exports["coderbox-components"] = factory(require("react"), require("styled-components"), require("lodash"), require("moment"), require("proptypes"), require("js-md5"), require("react-autosuggest"), require("react-markdown"));
	else
		root["coderbox-components"] = factory(root["react"], root["styled-components"], root["lodash"], root["moment"], root["proptypes"], root["js-md5"], root["react-autosuggest"], root["react-markdown"]);
...
var ListItemComponent = function (_React$Component) {
  ...
  _createClass(ListItemComponent, [{
    ...
    key: 'renderDate',
    value: function renderDate(startDate, endDate) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          (0, _moment2.default)(startDate).format('MMM/YYYY')
        ),
        _react2.default.createElement(
          'i',
          { className: 'material-icons' },
        ...
        _react2.default.createElement(
          'div',
          null,
          endDate ? (0, _moment2.default)(endDate).format('MMM/YYYY') : 'Present'
        )
      );
    }
  }, {
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          renderExtra = _props2.renderExtra;
...
exports.MarkdownStyle = exports.ToolbarStyle = exports.DatesStyle = exports.TitleSubtitleStyle = exports.LogoStyle = exports.ContainerStyle = undefined;
...
var ContainerStyle = exports.ContainerStyle = (0, _styledComponents2.default)(_flexbox2.default)(_templateObject, function (p) {
  return p.theme.colors.primary;
});

var LogoStyle = exports.LogoStyle = _styledComponents2.default.div(_templateObject2, function (p) {
  return p.theme.borderColors.base;
}, function (p) {
  return p.theme.shadow;
});
...
var DatesStyle = exports.DatesStyle = (0, _styledComponents2.default)(_flexbox2.default)(_templateObject4, function (p) {
  return p.theme.colors.gray;
});

var ToolbarStyle = exports.ToolbarStyle = _styledComponents2.default.div(_templateObject5, function (p) {
  return p.theme.colors.primary;
});

var MarkdownStyle = exports.MarkdownStyle = _styledComponents2.default.div(_templateObject6, function (p) {
  return p.theme.colors.gray;
});
