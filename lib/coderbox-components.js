(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("styled-components"), require("lodash"), require("prop-types"), require("moment"), require("js-md5"), require("react-autosuggest"), require("react-google-autocomplete"), require("react-markdown"), require("react-router"));
	else if(typeof define === 'function' && define.amd)
		define("coderbox-components", ["react", "styled-components", "lodash", "prop-types", "moment", "js-md5", "react-autosuggest", "react-google-autocomplete", "react-markdown", "react-router"], factory);
	else if(typeof exports === 'object')
		exports["coderbox-components"] = factory(require("react"), require("styled-components"), require("lodash"), require("prop-types"), require("moment"), require("js-md5"), require("react-autosuggest"), require("react-google-autocomplete"), require("react-markdown"), require("react-router"));
	else
		root["coderbox-components"] = factory(root["react"], root["styled-components"], root["lodash"], root["prop-types"], root["moment"], root["js-md5"], root["react-autosuggest"], root["react-google-autocomplete"], root["react-markdown"], root["react-router"]);
...
var EditableListItem = function (_React$Component) {
  ...
  _createClass(EditableListItem, [{
        ...
        function () {
          if (loading) {
            return _react2.default.createElement(
              ...
              null,
              _react2.default.createElement(_spinner2.default, { color: 'primary', align: 'flex-end', size: 32, hideLabel: true, hideOverlay: true })
            );
          } else {
            if (!editMode) {
              return _react2.default.createElement(
    ...
    value: function render() {
      ...
      var ItemElement = (0, _react.createElement)(itemProps.component || _ListItem2.default, _extends({}, itemProps, {
        item: item
      }));
...
var SpinnerComponent = function SpinnerComponent(_ref) {
  ...
  return _react2.default.createElement(
    ...
    { hide: hide, hideOverlay: hideOverlay, align: align },
    _react2.default.createElement(
      _styles.Spinner,
      { size: size, color: color, hideLabel: hideLabel },
...
var SpinnerContainer = exports.SpinnerContainer = _styledComponents2.default.div(_templateObject2, full(), function (p) {
  return p.hide ? 'none' : 'flex';
}, function (p) {
  return p.align;
}, function (p) {
  return p.hideOverlay ? 'transparent' : p.theme.overlay;
});
