...
var ListItemForm = function ListItemForm(_ref) {
  var item = _ref.item,
      ...
      suggestedTags = _ref$suggestedTags === undefined ? [] : _ref$suggestedTags,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_form.FormItem, {
        name: 'title',
  ...
  _createClass(ListItemContainer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        }) : _react2.default.createElement(_ListItem2.default, { item: item }),
        this.renderToolbar()
      );
    }
  }]);
...
ListItemContainer.defaultProps = { hideBlocks: [], className: '' };
